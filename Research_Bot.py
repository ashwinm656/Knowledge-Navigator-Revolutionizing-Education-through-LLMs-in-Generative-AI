...
class ResearchBot:
    ...
    def generateYouTubeLinks(self, userInput):
    ...
    def generate_research(self, userInput):
        ...
        with st.expander("Generative Results", expanded=True):
            ...
            with st.spinner("Generating YouTube Links"):
                self.generateYouTubeLinks(userInput)
    ...
    def run(self):
        ...
        with st.sidebar:
            ...
            with st.expander("LLM Settings", expanded=True):
                self.TEMP = st.slider("Temperature",0.0,1.0,0.65)
        if st.button("Generate Report") and userInput:
            self.generate_research(userInput)
